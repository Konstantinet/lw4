...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pTankMesh->LoadMesh("C:/Users/uzver/source/repos/glexamples/ogldev/Content/phoenix_ugv.md2")) {
            return false;
        }
        
        m_pSkyBox = new SkyBox(m_pGameCamera, m_persProjInfo);
        
        if (!m_pSkyBox->Init("C:/Users/uzver/source/repos/glexamples/ogldev/Content",
                             "sp3right.jpg",
                             "sp3left.jpg",
                             "sp3top.jpg",
                             "sp3bot.jpg",
    ...
    virtual void RenderSceneCB()
    {
        ...
        p.Rotate(0.0f, abs(sinf(m_scale/2)*360), 0.0f);
        p.WorldPos(sinf(m_scale) * 20, 3.0f, cosf(m_scale) * 20);
