...
public:
    ...
    Main()
    {
        ...
        m_spotLight.Color = Vector3f(0.0f, 1.0f, 1.0f);
        m_spotLight.Attenuation.Linear = 0.01f;
        m_spotLight.Position = Vector3f(-10.0f,20.0f,0.0f);
    ...
    bool Init()
    {
        ...
        if (!m_pQuad->LoadMesh("C:/Users/uzver/source/repos/glexamples/ogldev/Content/quad.obj")) {
            return false;
        }

        m_pGroundTex = new Texture(GL_TEXTURE_2D, "C:/Users/uzver/source/repos/glexamples/ogldev/Content/test.png");
        ...
        return m_pMesh->LoadMesh("C:/Users/uzver/source/repos/glexamples/ogldev/Content/phoenix_ugv.md2");
    }
